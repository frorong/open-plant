import { j as e, r as s, c as v, a as P, b as k, d as S, p as R, t as D, e as C, g as j, f as z, h as T, l as L, i as N, k as O, m as M, n as A, o as B, q as E, s as W, u as Z, v as $, w as U, x as H } from "./examples-playground-main-DlkosYcL.js";
const _ = `{
...
`, F = `import { buildClassPalette, closeRing, createCircle, createRectangle } from 'open-plant';
...
const Y = `import React, { useState } from 'react';
...
`, K = `import React, { useRef, useState } from 'react';
...
`, ee = `import React, { useEffect, useRef, useState } from 'react';
...
`, te = `import React, { useMemo, useState } from 'react';
...
`, oe = `import React, { useEffect, useMemo, useState } from 'react';
import {
  PointLayer,
  RegionLayer,
  WsiViewer,
...
`, ae = `import React, { useEffect, useRef, useState } from 'react';
...
function y({
  ...
  return /* @__PURE__ */ e.jsxs("div", { className: "examples-inline-demo", children: [
    /* @__PURE__ */ e.jsxs("div", { className: "examples-inline-demo-head", children: [
      /* @__PURE__ */ e.jsx("strong", { children: i.liveDemo }),
      /* @__PURE__ */ e.jsx("h3", { children: o })
    ] }),
    t ? /* @__PURE__ */ e.jsx("div", { className: "examples-inline-demo-actions", children: t }) : null,
    a,
    r ? /* @__PURE__ */ e.jsx("div", { className: "examples-inline-demo-metrics", children: r }) : null,
    /* @__PURE__ */ e.jsxs("div", { className: "examples-inline-demo-output", children: [
      /* @__PURE__ */ e.jsx("strong", { children: i.output }),
      /* @__PURE__ */ e.jsx("pre", { children: c || i.noOutput })
    ] })
  ] });
}
function x({
  ...
  const r = s.useMemo(() => re(o), [o]), c = s.useRef(null), [i, l] = s.useState(""), n = se[o];
  return s.useEffect(() => {
    const d = c.current, u = window.StackBlitzSDK;
    if (console.info("[open-plant/examples] stackblitz effect", {
      demo: o,
      hasHost: !!d,
      hasProject: !!r,
      hasSdk: !!u,
      ...
      if (!u?.embedProject) {
        console.error("[open-plant/examples] StackBlitz SDK missing", { demo: o }), l(t.previewUnavailable);
        return;
      }
      d.replaceChildren(), l(""), console.info("[open-plant/examples] embedding StackBlitz project", {
        demo: o,
        title: r.title,
        height: n.height,
        openFile: n.openFile
        ...
        console.info("[open-plant/examples] StackBlitz embed ready", { demo: o });
      }).catch((m) => {
...
${String(
  ...
  }, [o, t.previewUnavailable, n.height, n.openFile, r]), /* @__PURE__ */ e.jsxs("div", { className: "examples-inline-demo examples-inline-demo-stackblitz", children: [
    /* @__PURE__ */ e.jsxs("div", { className: "examples-inline-demo-head", children: [
      /* @__PURE__ */ e.jsx("strong", { children: t.stackblitzPreview }),
      /* @__PURE__ */ e.jsx("h3", { children: a })
    ] }),
    /* @__PURE__ */ e.jsx("div", { className: "examples-inline-demo-actions", children: /* @__PURE__ */ e.jsx(
      "button",
      {
        type: "button",
        onClick: () => {
          if (console.info("[open-plant/examples] open in StackBlitz clicked", { demo: o }), r && window.StackBlitzSDK?.openProject) {
            window.StackBlitzSDK.openProject(r, {
              newWindow: !0,
              openFile: n.openFile,
              showSidebar: !1,
              theme: "light"
    ...
    /* @__PURE__ */ e.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ e.jsx("div", { ref: c, className: "examples-inline-demo-stackblitz-host" })
      }
    ),
    /* @__PURE__ */ e.jsxs("div", { className: "examples-inline-demo-output", children: [
      /* @__PURE__ */ e.jsx("strong", { children: t.output }),
      /* @__PURE__ */ e.jsx("pre", { children: i || t.stackblitzReady })
    ] })
  ] });
}
function le({ lang: o }) {
  const a = g[o], t = s.useMemo(() => v(), []), [r, c] = s.useState(1), i = s.useMemo(
    () => W(t.rawImagePayload, "https://docs.open-plant.local/ims"),
    [t]
  ), l = s.useMemo(() => Z(t.rawImagePayload), [t]), n = s.useMemo(() => $(i, 3, 2, 1), [i]), d = [
    `run -> ${r}`,
    `id -> ${i.id}`,
    `size -> ${i.width} x ${i.height}`,
    `tile -> ${i.tileSize}, max tier -> ${i.maxTierZoom}`,
    `classes -> ${l.map((u) => `${u.classId}:${u.classColor}`).join(", ")}`,
    `token -> ${U("docs-token")}`,
    `tileUrl -> ${n}`
  ].join(`
`);
  return /* @__PURE__ */ e.jsx(
    y,
    {
      title: a.sectionSource,
      messages: a,
      controls: /* @__PURE__ */ e.jsx("button", { type: "button", onClick: () => c((u) => u + 1), children: a.runSource }),
      ...
      children: /* @__PURE__ */ e.jsxs("div", { className: "examples-inline-demo-source", children: [
        /* @__PURE__ */ e.jsxs("div", { children: [
          /* @__PURE__ */ e.jsx("strong", { children: a.sourcePreview }),
          /* @__PURE__ */ e.jsx("p", { children: i.name })
        ] }),
        /* @__PURE__ */ e.jsx("img", { src: n, alt: "Demo tile preview", className: "examples-inline-demo-tile" })
      ] })
    }
  );
}
function ce({ lang: o }) {
  const a = g[o], t = s.useMemo(() => v(), []), [r, c] = s.useState("worker"), [i, l] = s.useState(a.noOutput);
      ...
      controls: /* @__PURE__ */ e.jsxs(e.Fragment, { children: [
        /* @__PURE__ */ e.jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ e.jsx("option", { value: "sync", children: a.sync }),
              /* @__PURE__ */ e.jsx("option", { value: "worker", children: a.worker }),
              /* @__PURE__ */ e.jsx("option", { value: "hybrid-webgpu", children: a.hybrid })
            ]
          }
        ),
        /* @__PURE__ */ e.jsx(
          "button",
          {
            type: "button",
            onClick: async () => {
              const n = t.initialRegions.map((h) => D(h.coordinates)).filter(
                (h) => Array.isArray(h) && h.length > 0
              ), d = O(t.pointData, n), u = M(t.pointData, n), m = await A(
                t.pointData,
                n
              ), w = await B(
                t.pointData,
              ...
              l(
                [
                  `selected mode -> ${r}`,
                  `sync data -> ${d?.count ?? 0}`,
                  `sync indices -> ${u.length}`,
                  `worker data -> ${m.data?.count ?? 0} (${b(
                    m.meta.durationMs
                  )} ms)`,
                  `worker indices -> ${w.indices.length}`,
                  `hybrid drawIndices -> ${f.data?.drawIndices?.length ?? f.data?.count ?? 0}`
                ].join(`
`)
              );
            },
...
function de({ lang: o }) {
  const a = g[o], t = s.useMemo(() => v(), []), [r, c] = s.useState(a.noOutput);
  return s.useEffect(() => () => z(), []), /* @__PURE__ */ e.jsx(
    y,
    {
      title: a.sectionHitIndex,
      messages: a,
      controls: /* @__PURE__ */ e.jsx(
        "button",
        {
          type: "button",
          onClick: async () => {
            const i = await T(t.pointData, t.source);
            if (!i) {
              c("no index");
              return;
            }
            const l = Math.floor(t.queryCoordinate[0] / i.cellSize), n = Math.floor(t.queryCoordinate[1] / i.cellSize), d = L(i, l, n);
            c(
              [
                `cell size -> ${i.cellSize}`,
                `query coordinate -> ${t.queryCoordinate.join(", ")}`,
                `lookupCellIndex(${l}, ${n}) -> ${d}`,
                `bucket length -> ${d >= 0 ? i.cellLengths[d] : 0}`
              ].join(`
`)
            );
          },
          children: a.buildIndex
        }
      ),
      output: r
    }
    ...
    y,
    {
      ...
      controls: /* @__PURE__ */ e.jsx(
        "button",
        {
          type: "button",
          onClick: () => {
            const i = R(t.sampleWkt), l = D(
              i?.coordinates ?? t.initialRegions[0].coordinates
            ), n = C(t.pointData, t.initialRegions, {
            ...
            const u = d.search(t.sampleBounds);
            c(
              [
                `parseWkt -> ${i?.type ?? "-"}`,
                `polygon count -> ${l?.length ?? 0}`,
                `groups -> ${n.groups.length}, inside -> ${n.pointsInsideAnyRegion}`,
                `search -> ${u.map((m) => m.value.id).join(", ") || "-"}`
              ].join(`
`)
            );
          },
          children: a.runGeometry
        }
      ),
      output: r
    }
...
function me({ lang: o }) {
  const a = g[o], t = s.useMemo(() => v(), []), [r, c] = s.useState(4), i = P(
    t.source.mpp ?? 0.25,
  ...
  return /* @__PURE__ */ e.jsx(
    y,
    {
      ...
      output: [
        `calcScaleResolution -> ${b(i)}`,
        `calcScaleLength -> ${l}`,
        `clamp(1.6, 0, 1) -> ${S(1.6, 0, 1)}`
      ].join(`
`)
    }
  );
...
function he({
  ...
  const t = g[o];
  switch (console.info("[open-plant/examples] render InlineExamplesDemo", { demo: a, lang: o }), a) {
    case "composition":
      return /* @__PURE__ */ e.jsx(
        x,
        {
    ...
    case "source":
      return /* @__PURE__ */ e.jsx(le, { lang: o });
    case "points":
      return /* @__PURE__ */ e.jsx(
        x,
        {
    ...
    case "hit-index":
      return /* @__PURE__ */ e.jsx(de, { lang: o });
    case "geometry":
