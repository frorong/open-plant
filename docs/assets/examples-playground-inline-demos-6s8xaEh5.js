import { j as o, r as l } from "./examples-playground-main-D1fK9sxX.js";
const S = `{
...
}`, D = `import { defineConfig } from 'vite';
...
`, R = `import { buildClassPalette, closeRing, createCircle, createRectangle } from 'open-plant';
...
const C = `import React, { useState } from 'react';
...
${String(
      ...
      window.clearTimeout(f), window.clearTimeout(w), window.clearTimeout(b);
    };
  }, [
    t,
    e.previewUnavailable,
    ...
    /* @__PURE__ */ o.jsxs("div", { className: "examples-inline-demo-output", children: [
      ...
      /* @__PURE__ */ o.jsx("pre", { children: y || (d === "idle" ? `${e.stackblitzReady}
