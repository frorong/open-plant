import { j as e, r as s, c as v, a as P, b as k, d as S, p as R, t as D, e as C, g as j, f as z, h as T, l as L, i as N, k as O, m as M, n as A, o as B, q as E, s as W, u as Z, v as $, w as U, x as H } from "./examples-playground-main-Bk2jnALw.js";
const _ = `{
...
function x({
  ...
  return s.useEffect(() => {
    ...
    if (console.error("[open-plant/examples] stackblitz effect", {
      ...
      d.replaceChildren(), l(""), console.error("[open-plant/examples] embedding StackBlitz project", {
        demo: o,
        title: r.title,
        height: n.height,
        openFile: n.openFile
        ...
        console.error("[open-plant/examples] StackBlitz embed ready", { demo: o });
      }).catch((m) => {
...
${String(
    ...
    /* @__PURE__ */ e.jsx("div", { className: "examples-inline-demo-actions", children: /* @__PURE__ */ e.jsx(
      "button",
      {
        type: "button",
        onClick: () => {
          if (console.error("[open-plant/examples] open in StackBlitz clicked", { demo: o }), r && window.StackBlitzSDK?.openProject) {
...
function he({
  ...
  const t = g[o];
  switch (console.error("[open-plant/examples] render InlineExamplesDemo", { demo: a, lang: o }), a) {
    case "composition":
      return /* @__PURE__ */ e.jsx(
        x,
        {
